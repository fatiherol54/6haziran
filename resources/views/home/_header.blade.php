...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/4.jpg"
            ...
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/5.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
            ...
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/6.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/1.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Walnut Cutting Board</a>
                    <span class="quantity-price">1 x <span class="amount">$100.00</span></span>
            ...
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/2.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Lucky Wooden Elephant</a>
                    <span class="quantity-price">1 x <span class="amount">$35.00</span></span>
            ...
            <li>
                <a href="single-product.html" class="image"><img src="{{asset('assets')}}/front/img/product/3.jpg"
                                                                 alt="Cart product Image"></a>
                <div class="content">
                    <a href="single-product.html" class="title">Fish Cut Out Set</a>
                    <span class="quantity-price">1 x <span class="amount">$9.00</span></span>
                        ...
                        <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                            <li>
                                <a href="#" id="dropdown1" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">Hesabım <i class="ion ion-ios-arrow-down"></i></a>
                                <ul class="topnav-submenu dropdown-menu" aria-labelledby="dropdown1">
                                    <li><a href="{{route('anasayfa')}}">Hesabım</a></li>
                            ...
                            <li class="english">
                                <a href="#" id="dropdown3" class="pr-0" data-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{asset('assets')}}/front/img/logo/us-flag.jpg" alt="us flag"> English
                                    <i class="ion ion-ios-arrow-down"></i>
                                </a>
                                <ul class="topnav-submenu dropdown-menu" aria-labelledby="dropdown3">
                                    <li class="active">
                                        <a href="#"><img src="{{asset('assets')}}/front/img/logo/us-flag.jpg" alt="us flag">
                                            English</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('assets')}}/front/img/logo/france.jpg" alt="france flag">
                                            Français</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6 col-lg-2 order-first">
                    <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                        <a href="index.html"><img src="{{asset('assets')}}/front/img/logo/logo-dark.jpg" alt="logo"></a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-5 col-xl-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-end">
                        <div class="media static-media mr-50 d-none d-lg-flex">
                            <img class="mr-3 align-self-center" src="{{asset('assets')}}/front/img/icon/1.png" alt="icon">
                            ...
                            <ul class="mega-menu row">
                                ...
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                            src="{{asset('assets')}}/front/img/mega-menu/1.jpg" alt="img"></a>
                                </li>
                                <li class="col-6 mt-4">
                                    <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                            src="{{asset('assets')}}/front/img/mega-menu/2.jpg" alt="img"></a>
                                </li>
                            </ul>
                        </li>
                        <li>
