                ...
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        <div class="footer-logo mb-35">
                            <a href="index.html">
                                <img src="{{asset('assets')}}/front/img/logo/logo-dark.jpg" alt="footer logo">
                            </a>
                        </div>
                        ...
                        <div class="address-widget mb-30">
                            <div class="media">
                                <span class="address-icon mr-3">
                                    <img src="{{asset('assets')}}/front/img/icon/phone.png" alt="phone">
                                </span>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="store d-flex">
                            <a href="https://www.apple.com/" class="d-inline-block mr-3"><img
                                    src="{{asset('assets')}}/front/img/icon/apple.png" alt="apple icon"> </a>
                            <a href="https://play.google.com/store/" class="d-inline-block"><img
                                    src="{{asset('assets')}}/front/img/icon/play.png" alt="apple icon"> </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="text-left">
                        <img src="{{asset('assets')}}/front/img/payment/1.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto col-lg-5 mb-5 mb-lg-0">
                        ...
                        <div class="product-sync-nav">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"> <img src="{{asset('assets')}}/front/img/slider/thumb/1.1.jpg"
                                                                       alt="product-thumb"></a>
                                </div>
                            </div>
                            <!-- single-product end -->
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-5 divide-right">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="{{asset('assets')}}/front/img/modal/1.jpg" alt="img">
                            </div>
