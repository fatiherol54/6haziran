...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">Platinum Banyo Admin Panel Girişi</p>

            <form action="{{route('admin_logincheck')}}" method="post">
                @csrf
                <div class="input-group mb-3">
                    <input type="email" value="{{ __('Email') }}" class="form-control" placeholder="Email">
                ...
                <div class="input-group mb-3">
                    <input type="password" value="{{ __('Password') }}"  class="form-control" placeholder="Şifre">
                    <div class="input-group-append">
                        <div class="input-group-text">
